...
class Fleet(SyncAPIClient):
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous Fleet client instance.

        This automatically infers the `api_key` argument from the `FLEET_API_KEY` environment variable if it is not provided.
        """
        if api_key is None:
            api_key = os.environ.get("FLEET_API_KEY")
        if api_key is None:
            raise FleetError(
                "The api_key client option must be set either by passing api_key to the client or by setting the FLEET_API_KEY environment variable"
            )
...
class AsyncFleet(AsyncAPIClient):
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async AsyncFleet client instance.
