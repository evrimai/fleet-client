...
from ...types.browsers.page_get_response import PageGetResponse
from ...types.browsers.page_get_full_response import PageGetFullResponse
from ...types.browsers.page_get_text_response import PageGetTextResponse
    ...
    def get_full(
        ...
        *,
        ...
        if not browser_id:
            raise ValueError(f"Expected a non-empty value for `browser_id` but received {browser_id!r}")
        return self._get(
            f"/browsers/{browser_id}/page/full",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
    ...
    def get_text(
        ...
        *,
        ...
        if not browser_id:
            raise ValueError(f"Expected a non-empty value for `browser_id` but received {browser_id!r}")
        return self._get(
            f"/browsers/{browser_id}/page/text",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
